...
| Przejście przy zmianie stacji (backend BASS) | Kontroluje zachowanie podczas przełączania między stacjami. **Natychmiastowe cięcie** (domyślne) od razu zatrzymuje poprzednią stację przed uruchomieniem nowej. **Krótkie przejście (1 sekunda)** i **Normalne przejście (2 sekundy)** uruchamiają nową stację bez przerwy, a potem stopniowo wyciszają poprzednią w tle, gdy nowy strumień zostanie potwierdzony jako aktywny. Przy ustawieniu Natychmiastowe cięcie nie ma wpływu na wydajność. Dostępne tylko z backendem BASS. |
